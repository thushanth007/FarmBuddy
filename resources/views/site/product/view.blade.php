                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="right-box-contain">
                                @if ($product->offer)
                                    <h6 class="offer-top">{{ number_format($product->offer, 0) }}% Off</h6>
                                @endif
                                ...
                                <div class="price-rating">
                                    <h3 class="theme-color price">
                                        ...
                                        @endif
                                        @if ($product->offer)
                                            <del class="text-content">Rs.{{ number_format($product->price, 0) }}</del>
                                        @endif
                                        @if ($product->offer)
                                            <span class="offer theme-color">({{ number_format($product->offer, 0) }}%
                                                off)</span>
                                        @endif
                                    </h3>
                                ...
                                <div class="pickup-box">
                                    <div class="product-info">
                                        <ul class="product-info-list product-info-list-2">
                                            ...
                                            <li>Tags : <a href="javascript:void(0)">{{ $product->category->title }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="vendor-box">
                            <div class="vendor-contain">
                                <div class="vendor-image">
                                    <img src="{{ asset('site/assets/images/vendor-page/logo/3.png') }}"
                                        class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <p class="vendor-detail">Our products are harvested at peak ripeness, ensuring maximum flavor
                                and nutrition. You’ll taste the difference with every bite!</p>
                                ...
                                <ul>
                                    <li>
                                        <div class="address-contact">
                                            ...
                                            <h5>Address: <span class="text-content">{{ $farm->street }},
                                                    {{ $farm->city }}, {{ $farm->postal_code }}</span></h5>
                                        </div>
                                    </li>
                                    ...
                                    <div class="product-footer">
                                        <div class="product-detail">
                                            ...
                                            <h5 class="price">
                                                ...
                                                @if ($re->offer)
                                                    <del>Rs.{{ number_format($re->price, 0) }}</del>
                                                @endif
                                            </h5>
                                            <div class="add-to-cart-box bg-white">
                                                <button class="btn btn-add-cart addcart-button"
                                                    onclick="window.location.href='{{ url('/product/' . $re->id . '/view') }}'">Add
    ...
    <div class="modal fade theme-modal question-modal" id="writereview" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="product-review-form" id="registerForm" method="post"
                    action="{{ url('/product/' . $product->id . '/review') }}">
                    {{ csrf_field() }}
                                ...
                                <div class="product-review-rating">
                                    <div class="product-rating">
                                        <h6 class="price-number">
                                            Rs.@if ($re->offer)
                                                {{ number_format($product->price - $product->price * ($product->offer / 100), 0) }}
                                            @else
