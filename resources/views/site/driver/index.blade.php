                    ...
                    <div class="breadcrumb-contain">
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active">Driver Sign Up</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form class="row g-4" id="registerForm" method="post" action="{{url('/driver-register')}}">
                            {{ csrf_field() }}
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="form-floating theme-form-floating">
                                        ...
                                        <label for="fullname">Driver's License Number *</label>
                                        <em class="error-msg">{!!$errors->first('license')!!}</em>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-floating theme-form-floating">
                                        ...
                                        <em class="error-msg">{!!$errors->first('vehicle_type')!!}</em>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-floating theme-form-floating">
                                ...
                                <div class="col-6">
                                    <div class="form-floating theme-form-floating">
                                        ...
                                        <em class="error-msg">{!!$errors->first('registration_number')!!}</em>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating theme-form-floating">
