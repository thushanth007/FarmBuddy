...
<section class="content">
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
            <li @if(Request::is('*location')) class="active" @endif><a href="{{url('admin/seller-location')}}"><i class="fa fa-bars"></i> <span> Mange</span></a></li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <body onload="initMap()">
                    ...
                    <form method="POST" action="/admin/seller-location">
                        @csrf
