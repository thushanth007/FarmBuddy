...
@section('content')
    ...
    <section class="content">
        @if($location->latitude == '') <div class="alert alert-warning"> Please update the location. <a href="{{url('/admin/driver-location')}}">Click here to update.</a></div> @endif
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                <i class="fa fa-bar-chart-o"></i>
                <h3 class="box-title">Income Processing Chart</h3>
              </div>
              <div class="box-body">
