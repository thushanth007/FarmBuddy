...
<section class="content-header">
    <h1>{{$singleData->farm_name}} Order <small>Control panel</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{url('admin/farmer-info')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">{{$singleData->farm_name}} Order</li>
    </ol>
</section>
...
<section class="content">
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li @if(Request::is('*farmer-info*')) class="active" @endif><a href="{{url('admin/farmer-info')}}"><i class="fa fa-bars"></i> <span> Mange</span></a></li>
            @if(!empty($singleData->id))
                <li @if(Request::is('*farmer-view*')) class="active" @endif><a href="{{url('admin/farmer-view/'. $singleData->id)}}"><i class="fa fa-search-plus"></i> <span> View</span></a></li>
            @endif
        </ul>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($row->farmer_payment_status == 0)
                                                <a href="{{ URL::to('admin/farmer-update-payment/'.$row->id)}}" class="btn btn-sm btn-warning"> <i class="fa fa-paper-plane"></i> Pay </a>
                                                @else
